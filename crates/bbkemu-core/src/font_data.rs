//! Built-in 8x8 bitmap font data
//! Each character is 8 bytes, one byte per row, MSB left

/// Font data for ASCII characters 0x20-0x7E (95 characters)
/// Each character is 8 bytes (8x8 pixels)
pub const FONT_DATA: [[u8; 8]; 95] = [
    // 0x20 ' ' (space)
...
pub fn get_font_bitmap(ch: u8) -> [u8; 8] {
    match ch {
        0x20..=0x7E => FONT_DATA[(ch - 0x20) as usize],
        _ => FONT_DATA[0], // Default to space for unknown characters
    }
}
